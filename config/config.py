...
config.wandb_name = 'upload_test'
config.log_dir = './log'
config.workers = 8
config.print_freq = 100
config.vis_freq = 300
config.eval_vis_freq = 40
config.seed = 42
...
config.model.input_from = "st"
config.model.head_cpt_path = ''
config.model.exist_head_temporal=False
...
config.train.fix_pretrained = False
config.train.trainable_module = []
config.train.pretrain_cpt_name = ""
config.train.resume_cpt_name = ""
