...
from eval_utils.task_inference_results import Task
# from eval_utils.task_inference_results_hybrid import Task
...
if __name__ == '__main__':
    ...
    if args.inference_path != "":
        config.inference_cache_path = args.inference_path
